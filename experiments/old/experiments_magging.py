...
from nldg.old.env.maximin import MaggingRF
from nldg.old.env.utils import gen_data_maximin
...
def main():
    ...
    for i in tqdm(range(n_sim)):
        ...
        mag_rf = MaggingRF(
            n_estimators=50, random_state=42, max_features=m_try
        )
    ...
    plot_mse_r2(
        mse_df, r2_df, "experiments_magging.pdf", name_method="magging"
    )
